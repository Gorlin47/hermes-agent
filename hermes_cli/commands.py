...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("jarvis", "Force this session to process prompts directly without delegation", "Configuration",
               args_hint="[on|off|status|policy]",
               subcommands=("on", "off", "status", "enable", "disable", "policy", "map")),
